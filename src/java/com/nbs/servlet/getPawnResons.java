 ...
 * @author mmh
 */
public class getPawnResons extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<List<Object>> outPuts = new Server().searchMultipleResults(new ArrayList<>(), "ssp_bnk_LoadCombo_ViewPawnReason", 2);
            ...
            for (List outPut : outPuts) {
                output += " <tr class=\"select\">"
                        + "     <td class=\"convertSinhalaAmali\">" + outPut.get(0) + "</td>\n"
                        + "     <td class=\"convertSinhalaIskolaPotha\">" + outPut.get(1) + "</td>\n"
