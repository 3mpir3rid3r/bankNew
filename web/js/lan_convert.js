function keyup(from_e, to_e) {
    startText(from_e, [to_e]);
}
function startText(element, element2, type) {
    var a, b, c;
    text = element.value;
    ...
    for (var i = 0; i < element2.length; i++) {
        var temp_element = element2[i];
        if (temp_element.tagName === 'INPUT') {
        ...
        convert_into_Amali(text, element2, type);
...
var consonantsAma = new Array;
var consonantsAmali = new Array;
...
function convert_into_Amali(text, element2, type) {
