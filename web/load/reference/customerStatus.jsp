...
<%
    if (session.getAttribute("user") == null) {
        ...
        List searchMultipleResults = new referenceData().viewReferenceData(1, 2);
...
<section class="content">
    ...
    <div class="row container-fluid collapse" id="addItem" style="padding-top: 25px;">
        <form id="add" class="form-horizontal" action="managementServlet?id=1" method="post">
