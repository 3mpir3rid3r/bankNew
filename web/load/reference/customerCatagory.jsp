...
<%
    if (session.getAttribute("user") == null) {
        ...
        List searchMultipleResults, outPut;
%>
<style>
    #mytable td{
        padding: 0px;
...
<section class="content">
    ...
    <div class="row container-fluid collapse" id="addItem" style="padding-top: 25px;">
        <form id="add" class="form-horizontal" action="managementServlet?id=2" method="post">
            <div id="numberHolder" class="form-group" hidden>
                <label class="control-label col-sm-2 " >අංකය:</label>
                <div class="col-sm-10">          
                    <input readonly type="text" class="form-control" id="number" placeholder="අංකය" name="number" >
                </div>
            </div>
            ...
            <div id="codeHolder" class="form-group">
                <label class="control-label col-sm-2" >කේතය:</label>
                <div class="col-sm-10">          
                    <input type="text" class="form-control" id="code" placeholder="කේතය ඇතුලත් කරන්න" name="code" maxlength="1">
                </div>
            </div>
    ...
    <div id="table" class="table-responsive table-striped">
        <table id="mytable" class="table table-striped">
            ...
            <tbody>
                <%
                    ...
                    searchMultipleResults = new referenceData().viewReferenceData(2, 3);
                ...
                <tr>
                    ...
                    <td><%=outPut.get(2).toString().trim()%></td>
