...
<%
    if (session.getAttribute("user") == null) {
        ...
        List searchMultipleResults = new referenceData().viewReferenceData(5, 2);
...
<div id="content-header" class="row container-fluid">
    <h3>විවාහක තත්වය</h3>
    <hr>
    ...
    <div class="row container-fluid collapse" id="addItem" style="padding-top: 25px;">
        <form id="add" class="form-horizontal" action="managementServlet?id=6" method="post">
