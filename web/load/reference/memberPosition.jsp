...
<%
    if (session.getAttribute("user") == null) {
        ...
        List searchMultipleResults = new referenceData().viewReferenceData(3, 2);
...
<section class="content">
    ...
    <div class="row container-fluid collapse" id="addItem" style="padding-top: 25px;">
        <form id="add" class="form-horizontal" action="managementServlet?id=3" method="post">
