...
<%
    ...
    List searchMultipleResults = new referenceData().viewReferenceData(4, 3);
...
<section class="content">
    ...
    <div class="row container-fluid collapse" id="addItem" style="padding-top: 25px;">
        <form id="add" class="form-horizontal" action="managementServlet?id=4" method="post">
            ...
            <div id="codeHolder" class="form-group">
                ...
                <div class="col-sm-10">          
                    <input type="text" class="form-control" id="code" placeholder="කේතය ඇතුලත් කරන්න" name="code">
                </div>
            </div>
...
<div class="table-responsive table-striped">
    <table id="mytable" class="table table-bordred table-striped">
        ...
        <tbody>
            ...
            %>
            <tr>
                <td style="width: 20px;padding-left: 8px;" align="right">No data</td>
